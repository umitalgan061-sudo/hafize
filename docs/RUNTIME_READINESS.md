...
`ready` yalnız blocker, unknown ve warning kalmadığında true olur. Warning varsa sistem ready değil, degraded olarak işaretlenir; böylece “çalışıyor” ile “üretime hazır” ayrımı netleşir.
