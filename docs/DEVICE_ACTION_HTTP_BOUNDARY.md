...
Gerçek `server.mts` entegrasyonunda authentication middleware principal'ı, trace middleware trace kimliğini üretmeli; public request body bunları override edememelidir. Electron bridge yalnız güvenli runtime zinciri üzerinden çağrılmalıdır.
