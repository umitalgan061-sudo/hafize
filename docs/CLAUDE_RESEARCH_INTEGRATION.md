...
Manifest ve registry katmanı `lib/skills-manifest.mjs` + `lib/skills-registry.mjs` ile uygulandı (bkz. `docs/SKILLS_REGISTRY.md`); sıradaki adım server/tool yüzeyine bağlamaktır.
