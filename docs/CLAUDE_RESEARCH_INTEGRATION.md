...
İlk uygulama `lib/skill-manifest.mjs` + `lib/skill-registry.mjs` ile başlatıldı; sözleşme `docs/SKILLS_REGISTRY_CONTRACT.md` dosyasındadır. Server wiring ve skill kaynak yükleyicisi sıradaki turun önceliğidir.
