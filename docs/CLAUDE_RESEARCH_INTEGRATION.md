...
Sözleşme katmanı `lib/skill-manifest.mjs` ve `lib/skill-registry.mjs` ile uygulandı; ayrıntı `docs/SKILLS_REGISTRY_CONTRACT.md` içinde. Sıradaki adım skill yükleyicisi ve HTTP yüzeyidir.
