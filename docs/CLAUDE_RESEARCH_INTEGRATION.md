...
İlk uygulama `lib/skill-manifest.mjs`, `lib/skill-registry.mjs` ve `docs/SKILLS_REGISTRY_CONTRACT.md` ile sözleşme katmanı olarak başlatıldı; gerçek skill kaynağına bağlama sonraki turdadır.
