...
Sözleşme katmanı `lib/skills-manifest.mjs` + `lib/skills-registry.mjs` ile uygulandı
(bkz. `docs/SKILLS_REGISTRY_CONTRACT.md`); sıradaki adım server/runtime wiring ve skill kaynak yüklemesidir.
