...
const TYPED_ENTRIES = [
  ...
  'auth','browser-platform','chat-composer-features','chat-drafts','voice-output','workspace-navigation','chat-history-search','chat-history-management','chat-history-export','composer-history','settings-workspace','ui-shell','scheduled-tasks','voice-input','screen-share','hands-free','conversation-workspace','runtime-health'
] as const;
