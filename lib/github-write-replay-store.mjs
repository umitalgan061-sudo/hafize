...
async function closeRedisClient(target) {
  ...
  if (typeof target.destroy === 'function') {
    try {
      ...
      fail('GITHUB_WRITE_REPLAY_STORE_SHUTDOWN_FAILED');
    }
  }
  if (gracefulFailed || target.isOpen === true) fail('GITHUB_WRITE_REPLAY_STORE_SHUTDOWN_FAILED');
}
