...
export function createGmailSendToolBoundary(dependencies) {
  const { sendClient, ownerResolver } = optionalObject(dependencies, 'dependencies');
  ...
  async function execute(args, context) {
    const { principal, approvalGranted = false } = optionalObject(context, 'context');
