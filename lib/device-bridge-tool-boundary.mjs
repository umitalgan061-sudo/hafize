 ...
 *
 * @typedef {{ ok: false; error: string; reason?: string }} DeviceToolFailure
 * @typedef {DeviceToolFailure | {
 *   ok: true;
 *   request: Record<string, any>;
 *   permission: string;
 *   approvalRequired: boolean;
 * }} DeviceToolAuthorization
 * @typedef {DeviceToolFailure | { ok: true; [key: string]: any }} DeviceToolExecution
 */

/**
 * @param {string} error
 * @param {string} [reason]
 * @returns {DeviceToolFailure}
 */
...
/**
 * @param {UnvalidatedInput | null | undefined} input
 * @returns {DeviceToolFailure | { ok: true; request: Record<string, any>; policy: { permission: string; approvalRequired: boolean } }}
 */
...
/**
 * @param {UnvalidatedInput} agent
 * @param {UnvalidatedInput | null | undefined} input
 * @param {{ approvalGranted?: boolean }} [options]
 * @returns {DeviceToolAuthorization}
 */
 ...
 * @param {UnvalidatedInput} context
 * @returns {DeviceToolFailure | { ok: true }}
 */
function resolveTrustedApproval(request, context) {
  ...
  return context.approvalGranted === true ? { ok: true } : fail('DEVICE_TOOL_APPROVAL_REQUIRED', 'approval_required');
}
 ...
 * @param {UnvalidatedInput | null | undefined} input
 * @param {UnvalidatedInput} [context]
 * @returns {Promise<DeviceToolExecution>}
 */
