...
/**
 * @param {unknown} value
 * @param {ReadonlySet<string>} allowedProjects
 */
 ...
 * @param {boolean} approvalGranted
 * @param {boolean} intersectTools
 */
function classifyTools(agent, tools, approvalGranted, intersectTools) {
  const granted = [];
 ...
 * @param {readonly string[]} grantedTools
 */
function buildSkillPrompt(skill, values, grantedTools) {
 ...
 *
 * @param {{ allowedProjects?: string[] }} [options]
 */
export function createSkillsRegistry({ allowedProjects = [] } = {}) {
   ...
   * @param {{ source?: string; projectId?: string }} [origin]
   */
  ...
  /**
   * @param {Record<string, any>} agent
   * @param {{ intersectTools?: boolean }} [options]
   */
  function listForAgent(agent, { intersectTools = false } = {}) {
    const visible = [];
  ...
  /**
   * @param {{ agent?: any; name?: string; args?: Record<string, any>; approvalGranted?: boolean; intersectTools?: boolean }} [input]
   */
  function resolveInvocation({ agent, name, args, approvalGranted = false, intersectTools = false } = {}) {
