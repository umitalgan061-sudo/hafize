...
const COUNTS_VIEW = 'counts';
const SCHEDULE_LIST_VIEWS = new Set([SUMMARY_VIEW, COUNTS_VIEW]);
...
function normalizeScheduleListView(value = null) {
  ...
  if (typeof value !== 'string' || !SCHEDULE_LIST_VIEWS.has(value)) fail('INVALID_SCHEDULE_LIST_VIEW');
  return value;
}
