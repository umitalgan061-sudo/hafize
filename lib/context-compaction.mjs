...
export function createContextCompactor(options) {
  ...
  } = normalizeRequestInput(options, fail, 'options');
  ...
  async function prepare(messages, requestOptions) {
    const { model = '', signal } = normalizeRequestInput(requestOptions, fail, 'prepareOptions');
