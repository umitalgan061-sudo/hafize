...
/**
 * @param {unknown} value
 * @returns {number} Değerin içindeki tüm dizelerin toplam karakter sayısı.
 */
 ...
 * @returns {number} Karakter sayısına dayalı kaba jeton tahmini.
 */
 ...
 *
 * @param {{
 *   summarize?: (input: any) => Promise<string> | string;
...
export function createContextCompactor({
  ...
  /**
   * @param {HafizeWireMessage[]} messages
   * @param {{ model?: string; signal?: AbortSignal }} [context]
   */
  async function prepare(messages, { model = '', signal } = {}) {
