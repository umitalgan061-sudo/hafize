...
/**
 * @param {ReadonlySet<string>} scopes
...
/**
 * @param {{ tokenStore?: any; fetchImpl?: typeof fetch; now?: () => number; maxJsonBytes?: number }} [options]
 */
export function createCanvaReadClient({ tokenStore, fetchImpl = globalThis.fetch, now = () => Date.now(), maxJsonBytes = MAX_JSON_BYTES } = {}) {
  ...
  /** @param {{ ownerId?: string; operation?: string; params?: Record<string, any> }} [input] */
