...
function inspectValue(value, state, depth = 0) {
  // Every visited value consumes the node budget, not just containers: a flat
  // object carrying thousands of scalar fields is as expensive to inspect and
  // serialize as a deeply nested one, so width has to be bounded too.
