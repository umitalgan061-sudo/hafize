...
function inspectValue(value, state, depth = 0) {
  // Every inspected value counts, not just objects: a flat payload with thousands of
  // scalar fields is exactly as expensive to hand onward as a deeply nested one.
