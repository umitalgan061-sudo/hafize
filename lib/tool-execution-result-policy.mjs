...
function inspectValue(value, state, depth = 0) {
  // Every visited value counts against the node budget, including scalars:
  // traversal cost grows with property and element fan-out, not only with
  // nesting, so a single very wide object must be refused too.
