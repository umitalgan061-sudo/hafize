...
/**
 * @param {{ action?: unknown; [key: string]: any } | null | undefined} input
 */
 ...
 *
 * @param {{ approvalStore?: any; now?: () => number; randomId?: () => string }} [options]
 */
export function createDeviceApprovalReviewStore({ approvalStore, now = () => Date.now(), randomId = randomUUID } = {}) {
  ...
  /**
   * @param {{ traceId?: string; request?: any; ttlMs?: number }} [input]
   * @returns {{ ok: false; error: string } | { ok: true; review: Record<string, any>; audit: Record<string, any> }}
   */
  ...
  /**
   * @param {{ reviewId?: string; traceId?: string }} [input]
   */
