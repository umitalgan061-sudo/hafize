...
export function evaluateRuntimeReadiness(report = {}) {
  ...
  return Object.freeze({
    // A warning is a degraded component, so the runtime is not "ready" while one
    // stands: readiness is the signal a deploy gate reads, and it must not go green
    // on a runtime that is only partly healthy.
