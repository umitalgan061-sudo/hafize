...
// `now` ledger zaman damgalarını üretir ve `toISOString()` ile serileştirilir,
// bu yüzden bir `Date` döndürmelidir.
interface Options { readonly traceId: unknown; readonly agentId: unknown; readonly action?: unknown; readonly now?: (() => Date) | undefined; }
