 ...
 *   createNonce?: (size: number) => Uint8Array;
 * }} [options]
 */
export function createOAuthTokenFileStore({
  ...
  /**
   * @param {{ ownerId?: string; provider?: string; tokenRecord?: unknown }} [input]
   */
  ...
  /**
   * @param {{ ownerId?: string; provider?: string }} [input]
   */
   ...
   *
   * @param {{ ownerId?: string; provider?: string; explicitUserIntent?: boolean }} [input]
   */
