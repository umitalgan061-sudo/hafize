...
const MUTATIONS = new Set(['add', 'claimDue', 'complete', 'fail', 'defer', 'cancel']);
...
export function createTaskSchedulePersistence({ adapter, storeOptions = {}, createStore = createTaskScheduleStore }: { adapter?: any; storeOptions?: Record<string, any>; createStore?: Function } = {}) {
  ...
  function instantiate(snapshot: Record<string, any> | null = state) {
  ...
  function mutate(method: string, ...args: any[]) {
