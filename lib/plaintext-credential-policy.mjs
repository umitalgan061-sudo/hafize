// Ön ek olarak `\b` kullanılamaz: `NVIDIA_API_KEY=...` gibi env-var biçimlerinde
// alt çizgi sözcük karakteri olduğu için `\bapi_key` eşleşmez. Bunun yerine satır
// başı veya alfanümerik olmayan bir ayırıcı aranır.
