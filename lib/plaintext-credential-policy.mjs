// Credential names are usually namespaced (`NVIDIA_API_KEY`, `google.client_secret`),
// so an underscore/dot prefix must not hide the assignment behind a word boundary.
