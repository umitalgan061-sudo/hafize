// A leading \b would miss the common prefixed form (NVIDIA_API_KEY=..., MY_CLIENT_SECRET: ...)
// because '_' is itself a word character; anchor on a non-alphanumeric instead.
...
function isCredentialFieldName(name) {
  ...
  // Prefixed names (nvidiaApiKey, githubAccessToken) carry the same material.
