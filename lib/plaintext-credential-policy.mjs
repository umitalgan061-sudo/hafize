// A leading prefix such as NVIDIA_API_KEY joins on an underscore, which is a word
// character, so a plain \b would miss every prefixed environment variable name.
