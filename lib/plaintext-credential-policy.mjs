// A leading `\b` would miss the most common real-world spelling, because the
// underscore in `NVIDIA_API_KEY=` / `GOOGLE_CLIENT_SECRET=` is itself a word
// character and therefore not a word boundary. Accept any non-alphanumeric
// prefix (including `_`) or the start of the string instead.
