// `\b` bir credential adının önündeki `_` veya `.` ayırıcısını sınır saymaz;
// bu yüzden NVIDIA_API_KEY=... gibi ön ekli isimler yakalanmaz. Sınırı yalnız
// harf/rakam komşuluğuna göre tanımlamak ön ekli adları da kapsar ve
// "tokenlarını" gibi kelime içi eşleşmeleri dışarıda bırakır.
