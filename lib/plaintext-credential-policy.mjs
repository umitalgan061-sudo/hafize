// The leading boundary is intentionally not `\b`: prefixed environment names such as
// `NVIDIA_API_KEY=` or `HAFIZE_AUTH_TOKEN=` have no word boundary before the credential word.
