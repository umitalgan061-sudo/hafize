...
function normalizeModel(value) {
  // JSON manifests cannot express `undefined`, so an empty/blank string is the
  // on-disk spelling of "no model override" and normalizes to the same '' as an
  // omitted field. Any other value must still be a valid provider model id.
