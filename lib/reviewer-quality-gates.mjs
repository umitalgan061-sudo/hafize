const SECRET_PATTERNS = [
  // The dashes are optional: a key that lost its armor to reflowing or quoting is
  // still key material, and this gate reports findings for a human reviewer, so a
  // false positive costs a review comment while a miss costs a leaked key.
