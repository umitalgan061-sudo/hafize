const SECRET_PATTERNS = [
  // Armor çizgileri opsiyoneldir: inceleme girdisi kırpılmış, yeniden sarılmış
  // veya alıntılanmış olabilir. Bu kapı runtime'ı kesmez, bir review bulgusu
  // üretir; anahtar materyalini kaçırmaktansa fazladan uyarmak yeğdir.
