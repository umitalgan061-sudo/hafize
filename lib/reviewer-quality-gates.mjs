const SECRET_PATTERNS = [
  // Armor çizgileri opsiyoneldir: inceleme girdisi kırpılmış, satırı yeniden
  // sarılmış veya alıntılanmış olabilir. Bu kapı bir review bulgusu üretir,
  // runtime'ı kesmez; anahtar materyalini kaçırmaktansa fazladan uyarmak yeğdir.
