...
import { createCanvaReadClient } from './canva-read-client.mts';
import { createCanvaReadToolBoundary } from './canva-read-tool-boundary.mts';
...
export function createCanvaAgentRuntime({ env = process.env, fetchImpl = globalThis.fetch, createAuthenticator = createBearerPrincipalAuthenticator, createOwnerResolver = createConnectorOwnerResolver, createTokenStoreRuntime = createOAuthTokenStoreRuntime, createReadClient = createCanvaReadClient, createBoundary = createCanvaReadToolBoundary }: { env?: Record<string, string | undefined>; fetchImpl?: HafizeFetch; createAuthenticator?: Function; createOwnerResolver?: Function; createTokenStoreRuntime?: Function; createReadClient?: Function; createBoundary?: Function; } = {}) {
  ...
  if (configuredCount === 0) {
    return Object.freeze({
      ...
      async connectionStatus() { return Object.freeze({ ok: false as const, error: 'CANVA_NOT_CONFIGURED' }); },
