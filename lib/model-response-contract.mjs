...
function normalizeToolCalls(toolCalls) {
  ...
  return Object.freeze(toolCalls.map((call) => {
    ...
    // normalize edilmiş bir yanıtı yeniden normalize eder ve orada tool call'lar
    // `{ id, name, arguments }` düzlüğündedir. Ham provider şekli
    // (`{ id, function: { name, arguments } }`) da aynı yoldan kabul edilir.
