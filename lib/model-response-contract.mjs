...
function normalizeToolCalls(toolCalls) {
  ...
  return Object.freeze(toolCalls.map((call) => {
    ...
    // Hem provider biçimi (`function.name`) hem de normalize edilmiş biçim
    // (`name`) kabul edilir; böylece normalize etme işlemi idempotenttir ve
    // `isTerminalModelResponse` normalize edilmiş yanıtla da çalışır.
