 ...
 * @returns {string[]} Aynı hash slot'una düşen kilit, fence ve tamamlandı anahtarları.
 */
 ...
 *
 * @param {{ redis?: RedisLike; keyPrefix?: string }} [options]
 */
export function createRedisScheduleLeaseAdapter({ redis, keyPrefix = 'hafize:schedule-lease' } = {}) {
  ...
  /**
   * @param {{ scheduleId?: string; holderId?: string; leaseMs?: number }} [input]
   */
  ...
  /**
   * @param {{ scheduleId?: string; holderId?: string; fence?: number; leaseMs?: number }} [input]
   */
  ...
  /**
   * @param {{ scheduleId?: string; holderId?: string; fence?: number; idempotencyKey?: string }} [input]
   */
  ...
  /**
   * @param {{ scheduleId?: string; holderId?: string; fence?: number }} [input]
   */
