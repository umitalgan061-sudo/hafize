 ...
 *
 * @param {{ store?: any; registry?: any; createTraceId?: () => string }} [options]
 */
export function createScheduleCommandBoundary({ store, registry, createTraceId } = {}) {
  ...
  /** @param {{ principal?: unknown; input?: Record<string, any> }} [request] */
  ...
  /** @param {{ principal?: unknown }} [request] */
  ...
  /** @param {{ principal?: unknown; scheduleId?: string }} [request] */
