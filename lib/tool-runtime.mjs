...
export async function executeNvidiaToolCall(agent, toolCall, context) {
  ...
  let args;
  try { args = parseArguments(toolCall.function.arguments); } catch { return { ok: false, error: 'INVALID_TOOL_ARGUMENTS' }; }
  try {
