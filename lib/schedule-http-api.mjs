...
export function createScheduleHttpApi(options) {
  const { authenticator, commands, readJson } = optionsOf(options);
  ...
  async function handle(incoming) {
    const { request, method, pathname, headers } = optionsOf(incoming);
