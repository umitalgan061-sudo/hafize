...
/** @param {Record<string, any> | null | undefined} headers */
...
/**
 * @param {Record<string, any> | null | undefined} output
 ...
 *
 * @param {{ authenticator?: any; commands?: any; readJson?: (request: any) => Promise<unknown> }} [options]
 */
export function createScheduleHttpApi({ authenticator, commands, readJson } = {}) {
  ...
  /**
   * @param {{ request?: any; method?: string; pathname?: string; headers?: Record<string, any> }} [input]
   */
