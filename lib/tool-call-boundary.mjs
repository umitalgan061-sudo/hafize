...
// Sınır hataları stabil bir `code` taşır. `sanitizeToolError` yalnız kod
// taşımayan (yabancı) hataları TOOL_EXECUTION_FAILED'e indirger; böylece
// sözleşmede tanımlı kodlar istemciye doğru şekilde ulaşır.
...
export function parseToolArguments(raw) {
  ...
  try {
    ...
    // Bozuk JSON modelden gelen bilinen bir durumdur; parser metni sızdırılmaz.
    throw boundaryError('INVALID_TOOL_ARGUMENTS');
  }
