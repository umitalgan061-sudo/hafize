...
// Boundary failures carry their code on the error object as well as the message, so
// sanitizeToolError() can surface the stable public code instead of the generic fallback.
function fail(code) {
