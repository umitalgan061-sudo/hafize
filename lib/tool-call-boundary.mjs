...
// Boundary rejections carry `code` so sanitizeToolError() reports the real reason instead
// of collapsing every malformed call into the generic TOOL_EXECUTION_FAILED envelope.
