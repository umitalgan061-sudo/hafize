...
// Boundary rejections carry a stable machine code, not just a message. Without
// it sanitizeToolError() collapsed every malformed call into the opaque
// TOOL_EXECUTION_FAILED, hiding which part of the call the provider got wrong.
