...
// Boundary hataları kodu `.code` üzerinde taşımalıdır: sanitizeToolError()
// yalnız `.code` okur ve mesajı public koda çevirmez. Kod eklenmediğinde bu
// sınırın bilinen hataları da çağırana TOOL_EXECUTION_FAILED olarak dönüyordu.
function fail(code) {
