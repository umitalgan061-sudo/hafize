...
// Hata kodu `.code` üzerinde taşınır: sanitizeToolError() yalnız `.code`
// okur, mesajı public koda çevirmez. Kod eklenmediğinde bu sınırın bilinen
// hataları da çağırana TOOL_EXECUTION_FAILED olarak dönüyordu.
function fail(code) {
