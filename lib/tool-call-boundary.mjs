...
// Boundary rejections must carry `code`, otherwise sanitizeToolError() collapses
// every malformed call into the generic TOOL_EXECUTION_FAILED.
function fail(code) {
...
export function parseToolArguments(raw) {
  ...
  try {
    ...
    // Provider JSON syntax errors stay inside the boundary as a stable code.
