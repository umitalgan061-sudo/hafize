...
// Boundary hataları sanitizeToolError tarafından okunabilmesi için `code` taşımalıdır;
// aksi hâlde tüm malformed tool-call'lar genel TOOL_EXECUTION_FAILED'e indirgenir.
