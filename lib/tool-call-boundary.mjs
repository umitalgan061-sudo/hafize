...
// Boundary rejections must keep their code: `sanitizeToolError` reads
// `error.code` and would otherwise collapse every rejection into the generic
// TOOL_EXECUTION_FAILED, hiding why a model call was refused.
function fail(code) {
