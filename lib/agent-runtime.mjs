...
// Registry doğrulayıcısı aynı sınırları araç kataloğuna karşı da uygulayabilsin
// diye dışa açılır; kaynak yine yukarıdaki iki kümedir, kopyalanmaz.
export const AGENT_PERMISSION_POLICY = Object.freeze({
  never: Object.freeze([...NEVER_AGENT_PERMISSIONS]),
  approvalOnly: Object.freeze([...APPROVAL_ONLY_PERMISSIONS])
});
