...
export function createCanvaReadToolBoundary(options) {
  const { readClient, ownerResolver } = requireObjectInput(options, 'options', invalid);
  ...
  async function execute(args, context) {
    const { principal } = requireObjectInput(context, 'context', invalid);
