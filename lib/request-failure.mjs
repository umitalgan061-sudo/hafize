...
function publicError(error) {
  ...
  // Upstream sağlayıcı gövdesi istemciye yansıtılmaz: içeriği kontrolümüzde
  // değildir ve istek yükünü veya iç ayrıntıyı geri yankılayabilir. Public
  // gövde yalnız kararlı hata kodunu ve doğrulanmış durumu taşır.
