...
function publicError(error) {
  ...
  // Upstream provider text can echo request content or internal identifiers, so the
  // public body carries only the stable error code — the same rule the stream path uses.
