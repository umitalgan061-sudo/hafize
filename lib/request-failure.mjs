...
function publicError(error) {
  ...
  if (error?.message === 'NVIDIA_CHAT_ERROR') {
    // Sağlayıcının ham hata gövdesi istemciye taşınmaz: içeriği denetimimiz
    // altında değildir ve arayüz bu alanı hiç kullanmaz. Bounded detail yalnız
    // sunucu tarafında (log/teşhis) tutulur.
