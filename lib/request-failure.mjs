...
function publicError(error) {
  ...
  // Provider'ın ham hata metni public gövdeye taşınmaz; yalnız kararlı hata kodu döner.
  // `error.detail` server-side teşhis için ayakta kalır ama istemciye yansıtılmaz.
