...
function publicError(error) {
  ...
  // Sağlayıcı diagnostic metni istemciye dönmez: upstream gövdesi model adı,
  // prompt parçası veya hesap bilgisi taşıyabilir. Detay yalnız sunucu
  // tarafındaki hata nesnesinde kalır; istemci stabil public kodu görür
  // (stream yolu zaten yalnız kodu gönderiyordu).
