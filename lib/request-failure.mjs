...
// Upstream provider error bodies can echo request content, so they never reach
// the public failure body; the stable error code is all a client needs.
const MAX_NVIDIA_DETAIL = 0;
