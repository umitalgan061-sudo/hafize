...
export function normalizeGmailSendRequest(input = {}, options) {
  ...
  if (options !== undefined && (!options || Array.isArray(options) || typeof options !== 'object')) {
    fail('INVALID_GMAIL_SEND_OPTIONS');
  }
  rejectUnknownFields(input);
  if (input.explicitUserIntent !== true) fail('GMAIL_SEND_EXPLICIT_INTENT_REQUIRED');
  if (options?.approvalGranted !== true) fail('GMAIL_SEND_APPROVAL_REQUIRED');
