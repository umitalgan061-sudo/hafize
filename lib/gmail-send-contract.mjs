...
export function normalizeGmailSendRequest(input = {}, options = {}) {
  ...
  if (!options || Array.isArray(options) || typeof options !== 'object') fail('GMAIL_SEND_APPROVAL_REQUIRED');
  const approvalGranted = options.approvalGranted === undefined ? false : options.approvalGranted;
