...
const fragments = [
  ...
  ['Array.isArray(parsed) ? parsed : parsed?.conversations', 'legacy ve sarmalanmış girdiler ayrı yollardan okunur'],
  ...
  ['function normalizeConversationList(value)', 'normalized input is canonicalized'],
...
// Uyumluluk matrisi daralmamalı ve her satır tekil olmalı.
