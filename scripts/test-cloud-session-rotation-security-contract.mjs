...
for (const externalWriteTool of ['repo.write_branch', 'repo.merge', 'external.send', 'external.write']) {
  assert.equal(allTools.has(externalWriteTool), false, `rotation must not allow ${externalWriteTool} without approval`);
}
