...
assert.equal(store.write({ ownerId: 'u1', kind: 'note', content: 'PR küçük tutulacak.', sourceType: 'user_statement', sensitivity: 'personal', explicitUserIntent: true }).ok, true);
