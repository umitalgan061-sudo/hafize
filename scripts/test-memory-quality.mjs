...
assert.equal(store.write({ ownerId: 'u1', kind: 'project', content: 'PR küçük tutulacak.', sourceType: 'user_note', sourceRef: null, sensitivity: 'personal', explicitUserIntent: true }).ok, true);
