...
// QA planı Türkçe başlıklar kullanır; sözleşme başlıkların varlığıdır.
assert.match(qa, /Temel akış/); assert.match(qa, /Erişilebilirlik/); assert.match(qa, /PWA/); assert.match(qa, /Regresyon/);
