...
assert.deepEqual(saves,
  [{ ownerId: 'owner:1', provider: 'canva', tokenRecord: { accessToken: 'access-token', refreshToken: 'refresh-token', tokenType: 'Bearer', scopes: ['asset:read', 'design:meta:read'], expiresAt: 1_700_014_400_000 } }]);
...
for (const payload of [null, {}, { access_token: 'a', refresh_token: 'r', token_type: 'MAC', expires_in: 14400 }, { access_token: 'a', refresh_token: 'r', token_type: 'Bearer', expires_in: 1 },
  { access_token: 'a', refresh_token: '', token_type: 'Bearer', expires_in: 14400 }, { access_token: 'a', refresh_token: 'r', token_type: 'Bearer', expires_in: 14400, scope: 'x'.repeat(5000) }]) {
