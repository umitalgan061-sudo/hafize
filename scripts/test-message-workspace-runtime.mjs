...
// Same-tab synchronization: one dispatch and one listener for the change event.
assert.ok(source.includes('window.dispatchEvent(new CustomEvent(STORAGE_EVENT'));
