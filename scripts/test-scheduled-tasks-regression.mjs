...
const [client, css, enhance, keyboard, countdown, index, sw, readme] = await Promise.all([
  ...
  read('public/scheduled-tasks-countdown.mts'),
...
// Ctrl/⌘ + Shift + T, and never while the caret is in an editable field.
assert.match(keyboard, /event\.ctrlKey \|\| event\.metaKey/);
