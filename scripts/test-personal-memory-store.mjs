...
// Owner scoping is a filter; the query only ranks, so alice's match leads her own records.
...
// Only the deleted record disappears; alice keeps her remaining memory.
