...
assert.equal(safeRunningActivity.includes('.env'), false);
...
console.log('Tool runtime OK: safe public running/completion activity, runtime status, delegation, and configured GitHub repo.read are policy-gated');
