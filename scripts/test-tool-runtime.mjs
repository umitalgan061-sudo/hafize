...
// agent_delegate yalnız runtime bir delegateAgent sağladığında sunulur.
...
assert.deepEqual(
  getAllowedNvidiaTools(hafize, { githubReadConfigured: true, delegateAgent: () => ({ ok: true, value: {} }) }).map((tool) => tool.function.name),
