...
// `agent_delegate` yalnız context bir `delegateAgent` sağladığında kullanılabilir;
// delegasyon bağlamı olmayan istekte primary ajan runtime_status + skill_invoke görür.
