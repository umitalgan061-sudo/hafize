...
for (const content of ['Authorization: Bearer abcdefghijklmnop', 'github_pat_1234567890abcdefghijABCDEFGHIJ', 'nvapi-1234567890abcdefghijklmnopqrstuv', 'private_key: -----BEGIN PRIVATE KEY-----']) expectInvalid({ ok: true, content },
  'content_credential');
