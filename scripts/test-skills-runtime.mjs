...
// Bir skill yalnız ajanın tüm gerekli yetkilerine sahip olduğu durumda görünür.
// hafize-general `repo.read` taşımaz, bu yüzden code-inspection listelenmez.
...
// createSkillsRuntime async'tir: hata senkron fırlatılmaz, promise reddedilir.
