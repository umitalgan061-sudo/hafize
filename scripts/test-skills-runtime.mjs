...
// The primary agent has no `repo.read`, so the read-only code skill stays hidden
// from it and is only surfaced to the specialists that already hold that permission.
