...
// Skills are filtered by the agent's own tool policy: the primary agent has no repo.read,
// so code-inspection stays with the reviewer instead of widening the primary agent.
...
assert.equal(runtime.selectForAgent(general, 'kod incele', { minScore: 0.3 }), null, 'unauthorized skills are not selectable');
