...
// Görsel erişilebilirlik kuralları stil dosyasında, ARIA sözleşmesi ise
// panelin DOM'unu kuran modülde aranır.
...
const ariaContracts = [
  ["setAttribute('aria-valuemin', '0')", 'progressbar minimum is explicit'],
  ["setAttribute('aria-valuemax', '100')", 'progressbar maximum is explicit'],
  ["setAttribute('aria-valuenow'", 'progressbar current value is explicit'],
...
const shortcutBehaviorContracts = [
  ...
  ['function matchesEscape(event)', 'Escape has a dedicated guard'],
