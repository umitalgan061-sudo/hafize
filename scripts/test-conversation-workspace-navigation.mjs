...
const checkCount = responsiveContracts.length
  + cssAccessibilityContracts.length
  + ariaContracts.length
  + shortcutVisualContracts.length
  + shortcutBehaviorContracts.length;
console.log(`conversation-workspace-navigation: responsive, accessibility, shortcut, shell-order and no-network contracts passed (${checkCount} checks)`);
