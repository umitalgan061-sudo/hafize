...
assert.equal(source.includes("root.addEventListener?.('scroll', onViewportChange, true)"), true);
assert.equal(source.includes("root.removeEventListener?.('scroll', onViewportChange, true)"), true);
