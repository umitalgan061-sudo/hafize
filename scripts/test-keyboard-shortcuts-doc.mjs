...
for (const contract of ['Ctrl+K', '⌘K', '`/`', 'Ctrl+Shift+F', '⌘⇧F', '`Esc`', 'event.repeat', 'preventDefault()', 'network-only']) {
...
assert.equal(source.includes("focusConversationSearch: 'mod+shift+f'"), true);
