...
const tooManyToolCalls = Array.from(
  { length: MODEL_RESPONSE_CONTRACT.maxToolCalls + 1 },
  () => ({ id: 'x', function: { name: 'x', arguments: '{}' } })
);
assert.throws(
  () => normalizeNvidiaChatCompletion({ choices: [{ message: { role: 'assistant', tool_calls: tooManyToolCalls } }] }),
