...
// Smart Fill owns only its own preset key. Prompt records are updated
// through the core library API, never by writing its storage key here.
assert.doesNotMatch(smart, /hafize\.prompt-library\.v1/);
