...
// Reads go through the injected storage handle (default localStorage), so
// assert the read path rather than one literal call shape.
assert.match(source, /storage\.getItem\(|localStorage\.getItem\(/);
