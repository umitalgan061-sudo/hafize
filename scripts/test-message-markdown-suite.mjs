...
const tests = [
  ...
  'test-message-markdown-security-review.mjs',
  ...
  'test-message-markdown-assets.mjs',
  ...
  'test-message-markdown-preference.mjs',
  'test-message-markdown-preference-integration.mjs',
  'test-message-markdown-preference-pwa.mjs',
  'test-message-markdown-runtime.mjs',
  'test-message-actions.mjs',
  'test-message-actions-quote.mjs',
