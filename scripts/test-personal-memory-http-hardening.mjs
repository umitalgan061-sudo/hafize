...
const runtime = {
  ...
  authenticate(headers) {
    return headers?.authorization === 'Bearer ok' ? { ownerId: 'owner_private' } : null;
  },
  memory: {
    read(input) {
...
assert.deepEqual(calls[0][1], { ownerId: 'owner_private', query: 'tenis', kinds: ['preference'], limit: 3 });
