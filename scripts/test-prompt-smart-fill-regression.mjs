...
for (const asset of ['prompt-library-smart-fill.css','prompt-library-smart-fill.js','prompt-library-smart-fill-hints.js','prompt-library-command-palette.css','prompt-library-command-palette.js']) assert.match(sw,
