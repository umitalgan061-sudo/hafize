...
assert.deepEqual(mapToolFailureToApiError({ error: 'UPSTREAM', status: 504 }, 'r1'), { error: 'INTERNAL_ERROR', status: 504, message: '', requestId: 'r1' });
// requestId is optional: it is omitted rather than emitted as null when the caller has none.
