...
const runtime = {
  ...
  async beginReview(agent, request, context) {
    ...
    const browserOpen = request.action === 'browser.open';
    return {
      ok: true,
      review: {
        id: 'review-123',
        ...
        title: 'Onay',
        target: browserOpen ? 'https://example.com/private' : request.appId.toLowerCase(),
        detail: browserOpen ? 'Sorgu gizlendi.' : undefined,
        expiresAt: 123456,
