...
for (const token of ['Kullan','Mesaja aktar','aria-modal','aria-describedby','MAX_VALUE','MAX_VARIABLES','MAX_PRESETS','replaceVariables','composer.value','preventDefault']) assert.match(smart,
