...
assert.deepEqual(normalizeMemoryRetrieval({ ownerId: ' user-1 ', records: [record] }), { ok: true, records: [{ memoryId: 'memory_abcdefgh1234', kind: 'project', content: 'Hafize projesi üzerinde çalışıyor.', sourceType: 'user_statement',
