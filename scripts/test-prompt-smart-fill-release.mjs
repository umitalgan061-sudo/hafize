...
for (const asset of releaseAssets) assert.match(index,new RegExp(asset.replace(/[.*+?^${}()|[\]\\]/g,'\\$&')));
assertVersionedCacheDeclaration(sw);
for (const asset of releaseAssets) assert.match(sw,new RegExp(asset.replace(/[.*+?^${}()|[\]\\]/g,'\\$&')));
