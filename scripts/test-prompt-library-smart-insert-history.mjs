...
assert.match(source, /MAX_ENTRIES\s*=\s*40/); assert.match(source, /normalizeEntry\(/); assert.match(source, /normalizeHistory\(/); assert.match(source, /loadHistory\(/); assert.match(source, /saveHistory\(/); assert.match(source, /record\(/); assert.match(source, /remove\(/); assert.match(source, /clear\(/);
...
assert.match(bridge, /data-prompt-smart-insert/); assert.match(bridge, /hafize:prompt-library-variable-dialog/); assert.match(bridge, /reason !== 'insert'/); assert.match(bridge, /SmartInsertHistory\.record/); assert.doesNotMatch(bridge, /Object\.freeze\([^\n]*open/);
