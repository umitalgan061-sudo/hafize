...
assert(text.vite.includes("'app': resolve(ROOT, 'public/app.ts')"), 'app browser entry missing');
assert(text.vite.includes("'auth': resolve(ROOT, 'public/auth.ts')"), 'auth browser entry missing');
assert(text.vite.includes("'chat-composer-features': resolve(ROOT, 'public/chat-composer-features.ts')"), 'composer browser entry missing');
...
assert(text.vite.includes("'conversation-workspace-keyboard': resolve(ROOT, 'public/conversation-workspace-keyboard.ts')"), 'conversation keyboard entry missing');
assert(text.vite.includes("'message-workspace-policy': resolve(ROOT, 'public/message-workspace-policy.ts')"), 'message policy entry missing');
assert(text.vite.includes("'message-workspace': resolve(ROOT, 'public/message-workspace.ts')"), 'message workspace entry missing');
assert(text.vite.includes("'workspace-navigation': resolve(ROOT, 'public/workspace-navigation.ts')"), 'workspace navigation entry missing');
...
assert(text.index.includes('/typed-build/app.js'), 'app compiled entry missing from HTML');
assert(text.index.includes('/typed-build/auth.js'), 'auth compiled entry missing from HTML');
assert(text.index.includes('/typed-build/chat-composer-features.js'), 'chat-composer-features compiled entry missing from HTML');
assert(text.index.includes('/typed-build/conversation-workspace.js'), 'conversation-workspace compiled entry missing from HTML');
assert(text.index.includes('/typed-build/conversation-workspace-keyboard.js'), 'conversation-workspace-keyboard compiled entry missing from HTML');
assert(text.index.includes('/typed-build/message-workspace-policy.js'), 'message-workspace-policy compiled entry missing from HTML');
assert(text.index.includes('/typed-build/message-workspace.js'), 'message-workspace compiled entry missing from HTML');
assert(text.index.includes('/typed-build/workspace-navigation.js'), 'workspace-navigation compiled entry missing from HTML');
