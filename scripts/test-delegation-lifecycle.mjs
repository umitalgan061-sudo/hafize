...
let sequence = 0;
// Fan-out bütçesi tek bir task ledger'ındaki tüm `agent.delegate` kayıtlarından
// hesaplanır (bkz. docs/NESTED_DELEGATION.md). Bu yüzden birbirinden bağımsız
// senaryolar ledger'ı paylaşmaz; her senaryo kendi ledger'ıyla çalışır.
