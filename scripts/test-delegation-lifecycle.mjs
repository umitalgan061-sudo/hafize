...
const runLedger = createRunLedger();
...
let hold;
// A fresh ledger so the fan-out budget (documented as ledger-wide) does not
// pre-empt the concurrency limit this case is about.
