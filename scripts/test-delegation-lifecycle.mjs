...
const successDelegator = createAgentDelegator({ registry, traceId: 'trace-2', parentAgent: registry.agents[0], parentTaskId: 'root-2', runLedger, lifecycle: successLifecycle, async executeAgent() { return { ok: true,
  content: 'verified' }; } });
