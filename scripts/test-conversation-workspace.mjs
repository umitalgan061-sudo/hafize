...
// The number in that heading is policy the repository owner sets, so the suite
// asserts the section exists rather than pinning the figure it carries.
check('rules state the round completion criterion', rules.includes('## Tur tamamlama kriteri'));
