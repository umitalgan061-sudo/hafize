...
assert.match(center, /PROFILE_KEY/); assert.match(center, /MAX_PROFILES\s*=\s*24/); assert.match(center, /MAX_PROFILE_NAME\s*=\s*60/); assert.match(center, /keyForName/); assert.match(center, /Bu isimde bir profil zaten var/); assert.match(center, /favorite/); assert.match(center, /updatedAt/);
