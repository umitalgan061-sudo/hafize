(function exposeHafizeSwPolicy(root, factory) {
  ...
  const SHELL_ASSETS = Object.freeze([
    ...
    '/styles.css', '/premium.css', '/voice-output.css', '/screen-share.css', '/hands-free.css', '/workspace-navigation.css', '/chat-composer-features.css', '/chat-history-search.css', '/chat-history-export.css', '/settings-workspace.css', '/chat-history-management.css', '/chat-drafts.css', '/conversation-workspace.css', '/conversation-workspace-keyboard.css', '/message-workspace.css', '/prompt-library.css', '/prompt-library-smart-fill.css', '/prompt-library-command-palette.css', '/composer-history.css', '/scheduled-tasks.css', '/hafize-runtime.css',
    '/app.js', '/chat-history-export.js', '/conversation-workspace-keyboard.js', '/message-workspace-policy.js', '/message-workspace.js', '/prompt-library.js', '/prompt-library-starters.js', '/prompt-library-enhancements.js', '/prompt-library-keyboard.js', '/prompt-library-usage.js', '/composer-history-panel.js', '/composer-history-backup.js', '/composer-history-help.js', '/composer-history-settings.js', '/scheduled-tasks-enhancements.js', '/scheduled-tasks-keyboard.js', '/hands-free-background-guard.js',
    '/typed-build/auth.js', '/typed-build/app-runtime.js', '/typed-build/chat-composer-features.js', '/typed-build/chat-drafts.js', '/typed-build/chat-history-search.js', '/typed-build/chat-history-management.js', '/typed-build/composer-history.js', '/typed-build/conversation-workspace.js', '/typed-build/hands-free.js', '/typed-build/prompt-library-smart-fill.js', '/typed-build/prompt-library-command-palette.js', '/typed-build/prompt-library-smart-fill-hints.js', '/typed-build/prompt-library-usage.js', '/typed-build/scheduled-tasks.js', '/typed-build/scheduled-tasks-countdown.js', '/typed-build/screen-share.js', '/typed-build/settings-workspace.js', '/typed-build/ui-shell.js', '/typed-build/voice-input.js', '/typed-build/voice-output.js', '/typed-build/workspace-navigation.js',
