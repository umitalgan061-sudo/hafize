(function exposeHafizeSwPolicy(root, factory) {
  ...
  const SHELL_ASSETS = Object.freeze([
    ...
    '/chat-history-management.js', '/conversation-workspace.js', '/conversation-workspace-keyboard.js',
    '/message-workspace-policy.js', '/message-workspace.js',
    '/prompt-library.js', '/prompt-library-collections.js', '/prompt-library-collections-enhancements.js',
    ...
    '/scheduled-tasks-enhancements.js', '/scheduled-tasks-keyboard.js',
    '/voice-input.js', '/hands-free.js', '/hands-free-background-guard.js', '/screen-share.js',
    '/settings-workspace.js', '/ui-shell.js',
    ...
    '/typed-build/chat-drafts.js', '/typed-build/prompt-library-starters.js', '/typed-build/prompt-library-enhancements.js',
    '/typed-build/prompt-library-keyboard.js', '/typed-build/prompt-library-usage.js', '/typed-build/scheduled-tasks.js',
    '/typed-build/voice-output.js', '/typed-build/workspace-navigation.js',
