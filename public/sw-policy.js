(function exposeHafizeSwPolicy(root, factory) {
  ...
  const SHELL_ASSETS = Object.freeze([
    ...
    '/workspace-navigation.css', '/chat-composer-features.css', '/chat-markdown.css', '/chat-history-search.css', '/chat-history-export.css',
    ...
    '/prompt-library-import-preview.css', '/prompt-library-diagnostics.css', '/prompt-library-bulk-organizer.css', '/composer-history.css', '/scheduled-tasks.css', '/hafize-runtime.css',
    ...
    '/prompt-library-import-preview.js', '/prompt-library-diagnostics.js', '/prompt-library-bulk-organizer.js',
