(function exposeHafizeSwPolicy(root, factory) {
  ...
  const SHELL_ASSETS = Object.freeze([
    ...
    '/chat-history-management.js', '/chat-drafts.js', '/typed-build/markdown-renderer.js', '/typed-build/conversation-workspace.js', '/typed-build/message-workspace.js', '/conversation-workspace-keyboard.js',
