(function exposeHafizeSwPolicy(root, factory) {
  ...
  const SHELL_ASSETS = Object.freeze([
    ...
    '/prompt-library.css', '/prompt-library-smart-fill.css', '/prompt-library-command-palette.css', '/chat-markdown.css',
    '/prompt-library-collections.css', '/prompt-library-revisions.css',
    '/prompt-library-import-preview.css', '/prompt-library-diagnostics.css', '/composer-history.css', '/scheduled-tasks.css', '/hafize-runtime.css',
    '/chat-stream-control.css',
    '/auth.js', '/markdown-renderer.js', '/chat-markdown.js', '/chat-stream-policy.js', '/app.js', '/chat-stream-control.js',
    '/chat-composer-features.js', '/chat-history-search.js', '/chat-history-export.js',
    ...
    '/prompt-library-import-preview.js', '/prompt-library-diagnostics.js',
