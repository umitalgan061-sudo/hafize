(function exposeHafizeSwPolicy(root, factory) {
  ...
  const SHELL_ASSETS = Object.freeze([
    ...
    '/conversation-workspace.css', '/conversation-workspace-keyboard.css', '/message-workspace.css', '/prompt-library.css', '/prompt-library-smart-fill.css', '/prompt-library-command-palette.css', '/composer-history.css', '/scheduled-tasks.css', '/hafize-runtime.css',
    '/app.js', '/chat-history-search.js', '/chat-history-export.js', '/chat-history-management.js', '/conversation-workspace.js', '/conversation-workspace-keyboard.js', '/message-workspace-policy.js', '/message-workspace.js',
    '/prompt-library.js', '/prompt-library-starters.js', '/prompt-library-enhancements.js', '/prompt-library-keyboard.js', '/prompt-library-usage.js', '/composer-history-panel.js', '/composer-history-backup.js', '/composer-history-help.js', '/composer-history-settings.js',
    '/scheduled-tasks.js', '/scheduled-tasks-enhancements.js', '/scheduled-tasks-keyboard.js', '/voice-input.js', '/hands-free.js', '/hands-free-background-guard.js', '/screen-share.js', '/ui-shell.js',
    '/typed-build/auth.js', '/typed-build/app-runtime.js', '/typed-build/chat-composer-features.js', '/typed-build/chat-drafts.js', '/typed-build/chat-history-search.js', '/typed-build/chat-history-management.js', '/typed-build/composer-history.js', '/typed-build/prompt-library-smart-fill.js', '/typed-build/prompt-library-command-palette.js', '/typed-build/prompt-library-smart-fill-hints.js', '/typed-build/prompt-library-usage.js', '/typed-build/scheduled-tasks-countdown.js', '/typed-build/settings-workspace.js', '/typed-build/voice-output.js', '/typed-build/workspace-navigation.js', '/typed-build/ui-shell.js',
