(function exposeHafizeSwPolicy(root, factory) {
  ...
  const SHELL_ASSETS = Object.freeze([
    ...
    '/conversation-workspace.css', '/conversation-workspace-keyboard.css', '/message-workspace.css', '/chat-markdown.css',
    ...
    '/chat-history-management.js', '/chat-drafts.js', '/markdown-renderer.js', '/chat-markdown.js', '/typed-build/markdown-renderer.js', '/typed-build/conversation-workspace.js', '/typed-build/message-workspace.js', '/conversation-workspace-keyboard.js',
    ...
    '/settings-workspace.js', '/workspace-navigation.js',
