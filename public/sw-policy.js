(function exposeHafizeSwPolicy(root, factory) {
  ...
  const SHELL_ASSETS = Object.freeze([
    ...
    '/prompt-library.css', '/prompt-library-fill.css', '/prompt-library-smart-fill.css', '/prompt-library-command-palette.css',
    ...
    '/prompt-library-usage.js', '/prompt-library-fill.js', '/prompt-library-fill-presets.js', '/prompt-library-fill-keyboard.js', '/prompt-library-fill-backup.js',
    '/prompt-library-collections.js', '/prompt-library-collections-enhancements.js', '/prompt-library-revisions.js', '/prompt-library-revisions-enhancements.js',
