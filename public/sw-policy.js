(function exposeHafizeSwPolicy(root, factory) {
  ...
  const CURRENT_CACHE = `${CACHE_PREFIX}v28`;
  const SHELL_ASSETS = Object.freeze([
    ...
    '/prompt-library.css', '/prompt-library-smart-fill.css', '/prompt-library-command-palette.css', '/auth.js', '/app.js', '/chat-composer-features.js', '/chat-history-search.js', '/chat-history-export.js',
    ...
    '/prompt-library-smart-fill.js', '/prompt-library-command-palette.js',
