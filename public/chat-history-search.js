(() => {
  ...
  document.addEventListener('keydown', (event) => {
    ...
    // `SHORTCUT.shift` sabit olduğu için shift koşulu gerçekte hiç kontrol edilmiyordu;
    // kısayol mod+f'i ele geçirip tarayıcının kendi arama kutusunu engelliyordu.
