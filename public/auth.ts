/*
 * TypeScript migration step: runtime behavior is intentionally preserved while
 * the module is moved into the typed browser build. DOM/global contracts are
 * progressively typed at the surrounding boundary.
 */
// @ts-nocheck
(() => {
  'use strict';
